...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 16, fontWeight: '800', color: colors.ink900 },
  uni: { fontSize: 13, color: colors.ink500, marginTop: 1 },
  focusRow: { flexDirection: 'row', alignItems: 'center', gap: spacing(1), marginTop: 2 },
  focus: { flex: 1, fontSize: 12, color: colors.ink500 },
  headline: { fontSize: 14, color: colors.ink600, lineHeight: 20, marginTop: spacing(3) },
  ...
  rating: { fontSize: 14, fontWeight: '700', color: colors.ink900 },
  reviews: { fontSize: 13, color: colors.ink500 },
  fromLabel: { fontSize: 10, fontWeight: '700', letterSpacing: 0.5, color: colors.ink300 },
  price: { fontSize: 18, fontWeight: '800', color: colors.maroon900 },
});
