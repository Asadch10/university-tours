...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center justify-center rounded-2xl border border-dashed border-ink-300 bg-surface/60 px-6 py-16 text-center',
        className,
      )}
    >
...
export function ErrorState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-danger/25 bg-danger-solid/5 px-6 py-16 text-center">
      <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-danger-solid/10 text-danger">
        <AlertCircle size={26} />
      </span>
      <h3 className="mt-4 font-display text-lg font-semibold text-ink-900">{title}</h3>
...
export function ForbiddenState() {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-ink-200/70 bg-surface px-6 py-20 text-center">
